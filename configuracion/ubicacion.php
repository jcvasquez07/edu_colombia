...
if (isset($_POST['guardar'])) {
    $ubicacion = arreglar_texto(filter_input(INPUT_POST, 'ubicacion'));

    $error = "";
    $query = "INSERT INTO ubicaciones SET ubicacion = '$ubicacion'";
    $resultado = $mysqli->query($query);
    if ($mysqli->error) {
        $error = "No se pudo insertar en la tabla ubicaciones. El servidor dijo: " . htmlspecialchars($mysqli->error);
    }
...
if (isset($_POST['actualizar'])) {
    $id = filter_input(INPUT_POST, 'id_ubicacion');
    $ubicacion = arreglar_texto(filter_input(INPUT_POST, 'ubicacion'));
    $query = "UPDATE ubicaciones SET ubicacion = '$ubicacion' WHERE id = '$id'";
    $resultado = $mysqli->query($query);
}
...
<div class="container-fluid">
    <form enctype="multipart/form-data" method="POST" action="">
        <div class="form-row">
            <div class="col-auto">
                <label for="ubicacion" class="sr-only">Nueva ubicaci&#243;n</label>
            </div>
            <div class="col-md-4">
                <input type="text" name="ubicacion" class="form-control" id="ubicacion" placeholder="Nueva ubicacion" required>
            </div>
    ...
    <table class="table table-hover" id="dt_listado">
        ...
        <tbody data-link="row" class="rowlink">
            <?php
            $query = "SELECT * FROM ubicaciones WHERE 1 ORDER BY ubicacion";
            $resultado = $mysqli->query($query);
            $i = 0;
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalEditarLabel">Editar la Ubicaci&#243;n</h5>
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    <input type="hidden" name="id_ubicacion" value="<?php echo $row['id']; ?>" />
                ...
                <div class="modal" id="modalBorrar<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalBorrarTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>&#191;Esta seguro que desea borrar esta ubicaci&3243;n: <strong><?php echo $row['ubicacion']; ?>?</strong><p>
