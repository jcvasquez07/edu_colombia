...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        ****************************** -->
                ...
                <div class="card-body">
                    <ul class="todo-list" data-widget="todo-list">
                        <li>
                            ...
                            <!-- todo text -->
                            <span class="text">Todos Invitados</span>
                            <!-- Emphasis label -->
                        ...
                        <li>
                            ...
                            <span class="text">Nuevas Becas</span>
                        ...
                        <li>
                            ...
                            <span class="text">Nuevos Cursos</span>
        ...
        COLUMNA DERECHA
        ****************************** -->
        <!-- (agregamos el ID solo para que los widgets puedan ordenarse)-->
        <section class="col-lg-5 connectedSortable">
            ...
            <div class="card card-widget widget-user-2">
                ...
                <div class="widget-user-header bg-warning">
                    <div class="widget-user-image">
                        <img class="img-circle elevation-2" src="jc.jpg" alt="User Avatar">
                    </div>
                    <!-- /.widget-user-image -->
                    <h3 class="widget-user-username">Juan Carlos</h3>
            ...
            <!-- Map card -->
            <!-- Tuve que desaparecer este widgewt con css visibility pues afecta el calendario -->
            <div class="card bg-gradient-primary" style="visibility: collapse">
                <div class="card-header border-0">
                    <h3 class="card-title">
